  ...
  return (
    <section id="contacto" className="py-20 px-6 max-w-2xl mx-auto text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center">
        ...
        <a href="https://www.linkedin.com/in/andresromero" target="_blank" rel="noopener noreferrer" className="border border-blue-600 text-blue-400 hover:bg-blue-600 hover:text-white px-6 py-3 rounded-lg transition">
          LinkedIn
        </a>
